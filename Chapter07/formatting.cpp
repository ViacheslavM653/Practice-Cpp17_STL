...
int main()
{
    ...
    cout << "A hex with upper case letters: " 
         << hex << uppercase << 0x123abc << endl;
    cout << "A naumber " << 100 << '\n';
    cout << dec;
    cout << "Oops. now in decimal again: " << 100 << '\n';
    cout << "true/false values: " << true << ", " << false << '\n';
    cout << boolalpha << "true/false values: " << true << ", " << false << '\n';
    cout << "doubles: " << 12.3 << ", " << 12.0 << ", " << showpoint << 12.0 << '\n';
    cout << "scientific double: " << scientific << 12300000000000.123  << endl;
    cout << "fixed double: " << fixed << 12300000000000.123  << endl;
    cout << "very pricise double: " <<  setprecision(10) << 0.0000000001 << '\n';
    cout << "Less pricise double: " << setprecision(1) << 0.0000000001 << '\n';
